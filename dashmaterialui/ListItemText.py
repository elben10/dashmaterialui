...
- style (dict; optional): Add style object"""
    ...
    def __init__(self, children=None, classes=Component.UNDEFINED, disableTypography=Component.UNDEFINED, inset=Component.UNDEFINED, primary=Component.UNDEFINED, primaryTypographyProps=Component.UNDEFINED, secondary=Component.UNDEFINED, secondaryTypographyProps=Component.UNDEFINED, style=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'classes', 'disableTypography', 'inset', 'primary', 'primaryTypographyProps', 'secondary', 'secondaryTypographyProps', 'style']
        self._type = 'ListItemText'
        self._namespace = 'dashmaterialui'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'classes', 'disableTypography', 'inset', 'primary', 'primaryTypographyProps', 'secondary', 'secondaryTypographyProps', 'style']
