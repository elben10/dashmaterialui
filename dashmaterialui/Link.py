...
- variant (string; optional): Applies the theme typography styles."""
    @_explicitize_args
    def __init__(self, children=None, block=Component.UNDEFINED, classes=Component.UNDEFINED, color=Component.UNDEFINED, component=Component.UNDEFINED, href=Component.UNDEFINED, TypographyClasses=Component.UNDEFINED, underline=Component.UNDEFINED, variant=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'block', 'classes', 'color', 'component', 'href', 'TypographyClasses', 'underline', 'variant']
        self._type = 'Link'
        self._namespace = 'dashmaterialui'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'block', 'classes', 'color', 'component', 'href', 'TypographyClasses', 'underline', 'variant']
