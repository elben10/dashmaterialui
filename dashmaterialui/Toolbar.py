...
- variant (a value equal to: 'regular', 'dense'; optional): The variant to use."""
    @_explicitize_args
    def __init__(self, children=None, className=Component.UNDEFINED, disableGutters=Component.UNDEFINED, id=Component.UNDEFINED, style=Component.UNDEFINED, variant=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'className', 'disableGutters', 'id', 'style', 'variant']
        self._type = 'Toolbar'
        self._namespace = 'dashmaterialui'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'className', 'disableGutters', 'id', 'style', 'variant']
