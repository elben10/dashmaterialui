...
- variant (a value equal to: 'fullWidth', 'inset', 'middle'; optional): The variant to use."""
    @_explicitize_args
    def __init__(self, absolute=Component.UNDEFINED, className=Component.UNDEFINED, component=Component.UNDEFINED, id=Component.UNDEFINED, inset=Component.UNDEFINED, light=Component.UNDEFINED, style=Component.UNDEFINED, variant=Component.UNDEFINED, **kwargs):
        self._prop_names = ['absolute', 'className', 'component', 'id', 'inset', 'light', 'style', 'variant']
        self._type = 'Divider'
        self._namespace = 'dashmaterialui'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['absolute', 'className', 'component', 'id', 'inset', 'light', 'style', 'variant']
