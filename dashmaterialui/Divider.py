...
- variant (a value equal to: 'fullWidth', 'inset', 'middle'; optional): The variant to use."""
    @_explicitize_args
    def __init__(self, absolute=Component.UNDEFINED, classes=Component.UNDEFINED, component=Component.UNDEFINED, inset=Component.UNDEFINED, light=Component.UNDEFINED, style=Component.UNDEFINED, variant=Component.UNDEFINED, **kwargs):
        self._prop_names = ['absolute', 'classes', 'component', 'inset', 'light', 'style', 'variant']
        self._type = 'Divider'
        self._namespace = 'dashmaterialui'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['absolute', 'classes', 'component', 'inset', 'light', 'style', 'variant']
