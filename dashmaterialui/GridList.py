...
- style (dict; optional): Add style object"""
    @_explicitize_args
    def __init__(self, children=None, cellHeight=Component.UNDEFINED, className=Component.UNDEFINED, cols=Component.UNDEFINED, component=Component.UNDEFINED, id=Component.UNDEFINED, spacing=Component.UNDEFINED, style=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'cellHeight', 'className', 'cols', 'component', 'id', 'spacing', 'style']
        self._type = 'GridList'
        self._namespace = 'dashmaterialui'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'cellHeight', 'className', 'cols', 'component', 'id', 'spacing', 'style']
