...
- style (dict; optional): Add style object"""
    @_explicitize_args
    def __init__(self, children=None, cellHeight=Component.UNDEFINED, classes=Component.UNDEFINED, cols=Component.UNDEFINED, component=Component.UNDEFINED, spacing=Component.UNDEFINED, style=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'cellHeight', 'classes', 'cols', 'component', 'spacing', 'style']
        self._type = 'GridList'
        self._namespace = 'dashmaterialui'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'cellHeight', 'classes', 'cols', 'component', 'spacing', 'style']
