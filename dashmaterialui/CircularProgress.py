...
- variant (a value equal to: 'determinate', 'indeterminate', 'static'; optional): The variant to use. Use indeterminate when there is no progress value."""
    @_explicitize_args
    def __init__(self, classes=Component.UNDEFINED, color=Component.UNDEFINED, disableShrink=Component.UNDEFINED, size=Component.UNDEFINED, style=Component.UNDEFINED, value=Component.UNDEFINED, variant=Component.UNDEFINED, thickness=Component.UNDEFINED, **kwargs):
        self._prop_names = ['classes', 'color', 'disableShrink', 'size', 'style', 'value', 'variant']
        self._type = 'CircularProgress'
        self._namespace = 'dashmaterialui'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['classes', 'color', 'disableShrink', 'size', 'style', 'value', 'variant']
