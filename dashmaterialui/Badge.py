...
- variant (a value equal to: 'standard', 'dot'; optional): The variant to use."""
    @_explicitize_args
    def __init__(self, children=None, badgeContent=Component.UNDEFINED, classes=Component.UNDEFINED, color=Component.UNDEFINED, component=Component.UNDEFINED, invisible=Component.UNDEFINED, max=Component.UNDEFINED, showZero=Component.UNDEFINED, style=Component.UNDEFINED, variant=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'badgeContent', 'classes', 'color', 'component', 'invisible', 'max', 'showZero', 'style', 'variant']
        self._type = 'Badge'
        self._namespace = 'dashmaterialui'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'badgeContent', 'classes', 'color', 'component', 'invisible', 'max', 'showZero', 'style', 'variant']
