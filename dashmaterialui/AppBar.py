...
- style (dict; optional): Add style object"""
    @_explicitize_args
    def __init__(self, children=None, className=Component.UNDEFINED, color=Component.UNDEFINED, id=Component.UNDEFINED, position=Component.UNDEFINED, style=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'className', 'color', 'id', 'position', 'style']
        self._type = 'AppBar'
        self._namespace = 'dashmaterialui'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'className', 'color', 'id', 'position', 'style']
