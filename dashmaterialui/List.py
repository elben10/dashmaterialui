...
- subheader (a list of or a singular dash component, string or number; optional): The content of the subheader, normally ListSubheader."""
    @_explicitize_args
    def __init__(self, children=None, className=Component.UNDEFINED, component=Component.UNDEFINED, dense=Component.UNDEFINED, disablePadding=Component.UNDEFINED, id=Component.UNDEFINED, style=Component.UNDEFINED, subheader=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'className', 'component', 'dense', 'disablePadding', 'id', 'style', 'subheader']
        self._type = 'List'
        self._namespace = 'dashmaterialui'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'className', 'component', 'dense', 'disablePadding', 'id', 'style', 'subheader']
